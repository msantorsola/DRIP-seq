...
#SBATCH --job-name=rep1_231
#SBATCH --partition=gll_usr_prod
#SBATCH -N 1
#SBATCH -n 20
#SBATCH --mem=86000
#SBATCH --output=rep1_231.%J.out
#SBATCH --error=rep1_231.%J.err
...
exec 1>rep1_new_drip_2021_sambamba.log 2>&1
...
declare -a fastqs=("Sample_2_S2_L001_R1_001.fastq.gz " "Sample_2_S2_L001_R2_001.fastq.gz" "Sample_2_S2_L002_R1_001.fastq.gz" "Sample_2_S2_L002_R2_001.fastq.gz" "Sample_2_S2_L003_R1_001.fastq.gz" "Sample_2_S2_L003_R2_001.fastq.gz" "Sample_2_S2_L004_R1_001.fastq.gz" "Sample_2_S2_L004_R2_001.fastq.gz")
