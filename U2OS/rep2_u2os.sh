...
#SBATCH --job-name=rep2_U2OS
#SBATCH --partition=gll_usr_prod
#SBATCH -N 1
#SBATCH -n 20
#SBATCH --mem=86000
#SBATCH --output=rep2_U2OS.%J.out
#SBATCH --error=rep2_U2OS.%J.err
...
workDir=$WORK/drip_2021_rerun
tmpDir=$WORK/drip_2021_rerun/tmp
aligDir=$WORK/drip_2021_rerun/alignment
logDir=$WORK/drip_2021_rerun/logs
qualDir=$WORK/drip_2021_rerun/qual
varDir=$WORK/drip_2021_rerun/variant_calling


#create a logfile 
exec 3>&1 4>&2
trap 'exec 2>&4 1>&3' 0 1 2 3
exec 1>rep2_old_drip_2021_sambamba.log 2>&1
...
declare -a fastqs=("siGene2_S9_6_2_RV_S1_L001_R1_001.fastq.gz " "siGene2_S9_6_2_RV_S1_L001_R2_001.fastq.gz" "siGene2_S9_6_2_RV_S1_L002_R1_001.fastq.gz" "siGene2_S9_6_2_RV_S1_L002_R2_001.fastq.gz" "siGene2_S9_6_2_RV_S1_L003_R1_001.fastq.gz" "siGene2_S9_6_2_RV_S1_L003_R2_001.fastq.gz" "siGene2_S9_6_2_RV_S1_L004_R1_001.fastq.gz" "siGene2_S9_6_2_RV_S1_L004_R2_001.fastq.gz")
